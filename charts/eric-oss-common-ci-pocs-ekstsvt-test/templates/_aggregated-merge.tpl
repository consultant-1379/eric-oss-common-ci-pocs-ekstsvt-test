...
*/ -}}
{{- define "eric-oss-common-ci-pocs-ekstsvt-test.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-common-ci-pocs-ekstsvt-test.mergeAnnotations" -}}
  {{- include "eric-oss-common-ci-pocs-ekstsvt-test.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-common-ci-pocs-ekstsvt-test.mergeLabels" -}}
  {{- include "eric-oss-common-ci-pocs-ekstsvt-test.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
